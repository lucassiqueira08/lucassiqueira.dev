...
const ExploreCard = ({
  ...
  >
    ...
    {active !== id ? (
      <h3
        className="absolute z-0 text-[18px]
        font-semibold text-white sm:text-[26px] lg:bottom-20
        lg:origin-[0,0] lg:rotate-[-90deg]
      "
      >
        {title}
      </h3>
    ) : (
      <div className="absolute bottom-0 w-full flex-col justify-start rounded-b-[24px] bg-[rgba(0,0,0,0.5)] p-8">
        <div
